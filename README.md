...
4.  run Hydra with the following commands: ```/your/path/here/hydra-1.1-development-Venus/bin/hydra --num-iterations 4 --num-smac-runs 2 --num-configs-per-iter 1 --rungroup Hydra_Venus --num-run 1 --smacOptions /your/path/here/aclib2/scenarios/.../your-scenario-file.txt --smac-execution-options /your/path/here/smac-execution-options-local.txt```
